...
<head>
    ...
    <link href="<@spring.url '/static/css/icons.css'/>" rel="stylesheet">
    <link href="<@spring.url '/static/css/lightbox.css'/>" rel="stylesheet">
    <link href="<@spring.url '/static/css/media-player.css'/>" rel="stylesheet">
